...
import { GetCurrentAccessList } from 'Redux/actions/userAction';
import HeaderCiti from './HeaderCiti';

function ManageAccesss() {
  ...
  const Access = useSelector(state=> state?.accessListUser?.accessList?.accessListBins)
              ...
              <CardHeader className="border-0">
                <Row>
                  ...
                  // lg="6"
                    md="10"
                  >
                <h3 className="mb-0">List Of all Access point Bins</h3>
    ...
    <div className="spinner-border text-light" role="status">
      <span className="visually-hidden"></span>
            ...
            <div className="card">
              ...
              <DataTable paginator rows={5} rowsPerPageOptions={[5, 10, 25]} ref={dt} value={Access} header={header} selection={selectedProduct}
              selectionMode={true}

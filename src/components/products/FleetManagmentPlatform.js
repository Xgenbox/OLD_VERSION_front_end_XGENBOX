    ...
    <>
     ...
     <div className="position-relative">
            ...
            <div className="shape shape-style-1 shape-default mb--100 " style={{
              backgroundImage: `url(${require('assets/images/volvo-fh-heavy-truck-inside-view-interior-front-panel-besthqwallpapers.com-2560x1440-2-.jpeg')})`, height: "50vh",  backgroundSize: "cover", filter: "brightness(70%) "}}>

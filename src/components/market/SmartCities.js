        ...
        <div className="position-relative">
          ...
          <section className="section section-lg section-shaped pb-300 ">
            <div
              ...
              style={{
                backgroundImage:
                `url(${require('assets/images/pexels-robert-stokoe-717637-scaled.jpeg')})`,
                height: "50vh",
        ...
        >
          ...
          >
            <p>
              ...
              many are already well on their way! Along with smart traffic,
              smart lighting and smart energy, smart waste is an integral part
              of any smart city.
            </p>
            <p>
              Our offerings are fully stacked and vertically integrated so
              everyone sees and feels the direct benefits of using our solution,

...
function QRCodeGenerator() {
  ...
  const ListOfMedicine = useSelector(state=>state?.AllMedicines?.medicines?.data)
    ...
    <div className="spinner-border text-light" role="status">
      <span className="visually-hidden"></span>
            ...
            <div className="card">
              ...
              <DataTable paginator rows={5} rowsPerPageOptions={[5, 10, 25]} ref={dt} value={ListOfMedicine} header={header} selection={selectedProduct}
              selectionMode={true}
              onSelectionChange={(e) => setSelectedProduct(e.data)}
              filters={filters} filterDisplay="menu" globalFilterFields={['_id','name'  ]}
              onRowClick={
                (e) => {

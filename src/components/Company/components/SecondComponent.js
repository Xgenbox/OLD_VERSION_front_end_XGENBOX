      ...
      <SimpleGrid
        ...
        <div className="d-flex justify-content-center align-items-center  img-fluid  circle rounded rounded-circle" style={{backgroundColor: "white", width: "500px", height: "500px"}}>
          <img
            ...
            src={
              require("assets/images/Free-Office-Wall-Logo-Mockup-PSD-Template-copie-e1680465078878.png")
            }
            // "https://xgenbox.com/wp-content/uploads/2023/04/Free-Office-Wall-Logo-Mockup-PSD-Template-copie-e1680465078878.png"
            // width={800}
